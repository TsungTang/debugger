      ...
      <div className="mx-auto pt-[40px] w-11/12 lg:w-5/6 ">
        ...
        <div className="mt-5">
          ...
          <div className="flex pb-5 justify-around flex-wrap items-center">
            <Avatar className="mt-2 lg:mt-0" link={"https://github.com/bonzoyang"} imgComp={<Image src={"/avatars/bonzo.jpg"} width={120} height={140} />} name={"Yu Chun / PM & Backend & Data Scientist"} />
