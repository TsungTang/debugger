...
function DebuggerFilter({ currDate, handleSetCurrDate, showTrack, handleSetShowTrack, highlightFilter }) {
  ...
  return (
    <div className="w-60 h-52 absolute right-[4%] top-[10%] " style={{ zIndex: 999 }}>
      <div onClick={handleOpen} className={(highlightFilter ? "shadow-highlight " : "shadow-selector ") + (open ? "bg-white " : "bg-light-green ") + " flex items-center cursor-pointer  w-[100px] rounded-xl hover:bg-white  px-2 py-1 ml-auto"}>
